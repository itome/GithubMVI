            ...
            ObservableTransformer<RepositoryAction, RepositoryResult> { actions ->
                actions.publish { shared ->
                    Observable.merge(listOf(
                            shared.ofType(FetchRepositoryAction::class.java).compose(fetchRepositoryProcessor),
                            shared.ofType(FetchReadmeAction::class.java).compose(fetchReadmeProcessor),
                            shared.ofType(CheckIsStarredAction::class.java).compose(checkIsStarredProcessor),
