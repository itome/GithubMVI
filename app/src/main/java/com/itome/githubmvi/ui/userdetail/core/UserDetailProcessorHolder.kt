            ...
            actions.publish { shared ->
                Observable.merge(
                    listOf(
                        ...
                        shared.ofType(FetchUserReposAction::class.java).compose(
                            fetchUserReposProcessor
                        ),
                        shared.ofType(CheckIsLoginUserAction::class.java).compose(
                            checkIsLoginUserProcessor
                        ),
                        shared.ofType(CheckIsFollowedAction::class.java).compose(
                            checkIsFollowedProcessor
                        ),
